...
import com.telecorp.teledev.lukaapp.Service.ConnectionManager.CheckUserConnectionManager;
import com.telecorp.teledev.lukaapp.Service.ConnectionManager.LoginlogConnectionManager;
import com.telecorp.teledev.lukaapp.Service.ServiceMobile.CheckUserServiceMobile;
...
//                            loginlogRequest.setStatuslogin("Online");
                    loginlogRequest.setFromapp("LUKA");
                    ...
                    finish();
//                    Intent intentWebView = new Intent(getApplicationContext(), LoginActivity.class);
//                    startActivity(intentWebView);
